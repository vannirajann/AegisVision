...
csv_path = os.path.join(base_dir, "..", "output", "results", "test_interpolated.csv")
video_path = os.path.join(base_dir, "..", "test_images", "test_video.mp4")
out_path = os.path.join(base_dir, "..", "output", "videos", "out.mp4")
...
for car_id in np.unique(results['car_id']):
    ...
    x1, y1, x2, y2 = ast.literal_eval(
        results[(results['car_id'] == car_id) & (results['license_number_score'] == max_)]
